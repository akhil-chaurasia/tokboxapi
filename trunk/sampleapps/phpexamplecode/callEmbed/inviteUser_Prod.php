...
<html>
	...
	<body>
		<div style="width:100px;height:30px;background-color:gold;color:blue;line-height:30px;text-align:center;margin:10px;" onclick="sendInvite('510455', 'John', '510455@jabber.tokbox.com', '<?php echo $inviteId; ?>')">
			Invite User
		</div>
